...
// AZURE DIGITAL TWINS
param digitalTwinsName string = 'adt-convenient-store'
...
param storageAccountName string = 'ADTConvenientStoreStorageAccount'
...
param containerName string = 'convenientstoredigitaltwinscontainer'
